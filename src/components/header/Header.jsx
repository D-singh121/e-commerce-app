...
const Header = () => {
	...
	//***** fetching the cart state and showing the total cartItem there */
	...
	return (
		...
		<div className=" bg-white sticky top-0 z-50">
			...
			<header className="relative bg-white">
				...
				<nav aria-label="Top" className="bg-gray-100 px-4 sm:px-5 lg:px-8 shadow-xl " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
					<div className="">
						<div className="flex h-16 items-center">
							...
							>
								...
								<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 rounded-full ">
