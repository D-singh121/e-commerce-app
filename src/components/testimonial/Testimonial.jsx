...
function Testimonial() {
	...
	return (
		<div>
			<section className="text-gray-600 body-font " style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }}>
				<div className="container px-5 py-10 mx-auto ">
					...
					<div className="flex flex-wrap  border -m-4">
						<div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
							<div className="h-full text-center ">
								<img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src={profileImg} />
								...
								<span className="inline-block h-1 w-10 rounded bg-purple-700 mt-6 mb-4" />
								<h2 style={{ color: mode === 'dark' ? '#ff4162' : '' }} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Devesh Singh Choudhary</h2>
